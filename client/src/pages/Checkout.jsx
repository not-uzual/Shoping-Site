  ...
  const handleSubmitOrder = async (e) => {
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          "Shipping address is incomplete. Please provide all required information.",
        );
      }
      ...
      const paymentData = {
        ...
        transactionId:
          paymentInfo.method === "upi" ? paymentInfo.upiId : undefined,
      ...
      if (!response.success) {
        throw new Error(
          response.message || "Order creation failed on the server",
        );
      }
        ...
        <>
          <div className="mt-6 bg-white border border-gray-200 rounded-md p-6">
            <div className="flex justify-between items-center mb-4">
              <h4 className="font-medium text-lg">Add New Address <span className="text-red-600 font-normal text-[12px]">*You don't have any address saved in your profile</span></h4>
            </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div
                    ...
                    onClick={() =>
                      setPaymentInfo((prev) => ({ ...prev, method: "upi" }))
                    }
                  >
                    <div className="flex justify-between items-start">
                      <div>
                  ...
                  <div className="border-t pt-4 mt-4">
                    ...
                    <div className="relative">
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Example: yourname@okhdfcbank, yourname@ybl, etc.
                      </p>
                    </div>
                  </div>
                )}
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="mt-1 text-sm text-gray-600">
                            Pay in cash at the time of delivery. Please have the
                            exact amount ready.
                          </p>
                        </div>
                      </div>
